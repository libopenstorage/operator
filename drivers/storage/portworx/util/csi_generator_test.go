...
func TestCSIImages(t *testing.T) {
	...
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-node-driver-registrar:v2.3.0", images.NodeRegistrar)
	...
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-resizer:v1.3.0", images.Resizer)
