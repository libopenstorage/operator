...
func TestCSIImages(t *testing.T) {
	...
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-node-driver-registrar:v2.5.0", images.NodeRegistrar)
	...
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-resizer:v1.4.0", images.Resizer)
	...
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-snapshotter:v5.0.1", images.Snapshotter)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-resizer:v1.4.0", images.Resizer)
	...
	require.Equal(t, "docker.io/openstorage/csi-provisioner:v3.1.0-3", images.Provisioner)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-snapshotter:v5.0.1", images.Snapshotter)
	require.Equal(t, "k8s.gcr.io/sig-storage/snapshot-controller:v5.0.1", images.SnapshotController)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-resizer:v1.4.0", images.Resizer)
	...
	require.Equal(t, "k8s.gcr.io/sig-storage/snapshot-controller:v5.0.1", images.SnapshotController)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-resizer:v1.4.0", images.Resizer)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-external-health-monitor-controller:v0.5.0", images.HealthMonitorController)
}
