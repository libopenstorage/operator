...
func TestCSIImages(t *testing.T) {
	...
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-node-driver-registrar:v2.6.2", images.NodeRegistrar)
	...
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-resizer:v1.6.0", images.Resizer)
	...
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-snapshotter:v6.1.0", images.Snapshotter)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-resizer:v1.6.0", images.Resizer)
	...
	require.Equal(t, "docker.io/openstorage/csi-provisioner:v3.2.1-1", images.Provisioner)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-snapshotter:v6.1.0", images.Snapshotter)
	require.Equal(t, "k8s.gcr.io/sig-storage/snapshot-controller:v6.1.0", images.SnapshotController)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-resizer:v1.6.0", images.Resizer)
	...
	require.Equal(t, "k8s.gcr.io/sig-storage/snapshot-controller:v6.1.0", images.SnapshotController)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-resizer:v1.6.0", images.Resizer)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-external-health-monitor-controller:v0.7.0", images.HealthMonitorController)
	...
	require.Equal(t, "docker.io/openstorage/csi-attacher:v1.2.1-1", images.Attacher)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-node-driver-registrar:v2.6.2", images.NodeRegistrar)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-provisioner:v3.3.0", images.Provisioner)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-snapshotter:v6.1.0", images.Snapshotter)
	require.Equal(t, "k8s.gcr.io/sig-storage/snapshot-controller:v6.1.0", images.SnapshotController)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-resizer:v1.6.0", images.Resizer)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-external-health-monitor-controller:v0.7.0", images.HealthMonitorController)
