...
func TestCSIImages(t *testing.T) {
	...
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-node-driver-registrar:v2.5.1", images.NodeRegistrar)
	...
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-resizer:v1.5.0", images.Resizer)
	...
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-snapshotter:v3.0.3", images.Snapshotter)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-resizer:v1.5.0", images.Resizer)
	...
	require.Equal(t, "docker.io/openstorage/csi-attacher:v1.2.1-1", images.Attacher)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-node-driver-registrar:v2.5.1", images.NodeRegistrar)
	require.Equal(t, "docker.io/openstorage/csi-provisioner:v3.1.0-3", images.Provisioner)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-snapshotter:v6.0.1", images.Snapshotter)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-resizer:v1.5.0", images.Resizer)
	...
	require.Equal(t, "docker.io/openstorage/csi-provisioner:v3.1.0-3", images.Provisioner)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-snapshotter:v6.0.1", images.Snapshotter)
	require.Equal(t, "k8s.gcr.io/sig-storage/snapshot-controller:v6.0.1", images.SnapshotController)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-resizer:v1.5.0", images.Resizer)
	...
	require.Equal(t, "k8s.gcr.io/sig-storage/snapshot-controller:v6.0.1", images.SnapshotController)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-resizer:v1.5.0", images.Resizer)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-external-health-monitor-controller:v0.6.0", images.HealthMonitorController)

	k8sVersion, _ = version.NewSemver("1.23.4")
	gen = NewCSIGenerator(*k8sVersion, *pxVer2_12, false, false, "", true)
	images = gen.GetCSIImages()
	require.Equal(t, "docker.io/openstorage/csi-attacher:v1.2.1-1", images.Attacher)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-node-driver-registrar:v2.5.1", images.NodeRegistrar)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-provisioner:v3.2.1", images.Provisioner)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-snapshotter:v6.0.1", images.Snapshotter)
	require.Equal(t, "k8s.gcr.io/sig-storage/snapshot-controller:v6.0.1", images.SnapshotController)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-resizer:v1.5.0", images.Resizer)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-external-health-monitor-controller:v0.6.0", images.HealthMonitorController)
