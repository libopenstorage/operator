...
func TestCSIImages(t *testing.T) {
	...
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-node-driver-registrar:v2.1.0", images.NodeRegistrar)
	...
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-resizer:v1.1.0", images.Resizer)
	...
	images = gen.GetCSIImages()
	require.Equal(t, "k8s.gcr.io/sig-storage/snapshot-controller:v3.0.3", images.SnapshotController)
	require.Equal(t, "docker.io/openstorage/csi-attacher:v1.2.1-1", images.Attacher)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-node-driver-registrar:v2.1.0", images.NodeRegistrar)
	require.Equal(t, "docker.io/openstorage/csi-provisioner:v1.6.1-1", images.Provisioner)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-snapshotter:v3.0.3", images.Snapshotter)
	...
	gen = NewCSIGenerator(*k8sVersion, version.Version{}, false, false, "", true)
	images = gen.GetCSIImages()
	require.Equal(t, "k8s.gcr.io/sig-storage/snapshot-controller:v4.0.0", images.SnapshotController)
	require.Equal(t, "docker.io/openstorage/csi-attacher:v1.2.1-1", images.Attacher)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-node-driver-registrar:v2.1.0", images.NodeRegistrar)
	require.Equal(t, "docker.io/openstorage/csi-provisioner:v1.6.1-1", images.Provisioner)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-snapshotter:v4.0.0", images.Snapshotter)
	require.Equal(t, "k8s.gcr.io/sig-storage/csi-resizer:v1.1.0", images.Resizer)
