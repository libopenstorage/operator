...
func (in *CloudDeviceSpec) DeepCopyInto(out *CloudDeviceSpec) {
	*out = *in
	if in.Type != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CloudDeviceSpec.
func (in *CloudDeviceSpec) DeepCopy() *CloudDeviceSpec {
	if in == nil {
		return nil
	}
	out := new(CloudDeviceSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CloudStorageSpec) DeepCopyInto(out *CloudStorageSpec) {
	*out = *in
	if in.DeviceSpecs != nil {
		...
		*out = make([]*CloudDeviceSpec, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(CloudDeviceSpec)
