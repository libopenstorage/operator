...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AuthenticatorsSpec) DeepCopyInto(out *AuthenticatorsSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AuthenticatorsSpec.
func (in *AuthenticatorsSpec) DeepCopy() *AuthenticatorsSpec {
	if in == nil {
		return nil
	}
	out := new(AuthenticatorsSpec)
