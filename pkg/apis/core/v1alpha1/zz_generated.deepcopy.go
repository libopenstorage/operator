...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StorageClusterDeleteStatus) DeepCopyInto(out *StorageClusterDeleteStatus) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StorageClusterDeleteStatus.
func (in *StorageClusterDeleteStatus) DeepCopy() *StorageClusterDeleteStatus {
	if in == nil {
		return nil
	}
	out := new(StorageClusterDeleteStatus)
	in.DeepCopyInto(out)
	return out
}
