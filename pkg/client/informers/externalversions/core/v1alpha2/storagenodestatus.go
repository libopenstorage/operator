...
import (
	...
	v1alpha2 "github.com/libopenstorage/operator/pkg/client/listers/core/v1alpha2"
...
type StorageNodeStatusInformer interface {
	...
	Lister() v1alpha2.StorageNodeStatusLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CoreV1alpha2().StorageNodeStatuses(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CoreV1alpha2().StorageNodeStatuses(namespace).Watch(options)
			},
		},
		&corev1alpha2.StorageNodeStatus{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *storageNodeStatusInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&corev1alpha2.StorageNodeStatus{}, f.defaultInformer)
}

func (f *storageNodeStatusInformer) Lister() v1alpha2.StorageNodeStatusLister {
	return v1alpha2.NewStorageNodeStatusLister(f.Informer().GetIndexer())
}
