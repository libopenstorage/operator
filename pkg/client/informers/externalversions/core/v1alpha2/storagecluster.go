...
type StorageClusterInformer interface {
	...
	Lister() v1alpha2.StorageClusterLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CoreV1alpha2().StorageClusters(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CoreV1alpha2().StorageClusters(namespace).Watch(options)
			},
		},
		&corev1alpha2.StorageCluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *storageClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&corev1alpha2.StorageCluster{}, f.defaultInformer)
}

func (f *storageClusterInformer) Lister() v1alpha2.StorageClusterLister {
	return v1alpha2.NewStorageClusterLister(f.Informer().GetIndexer())
}
