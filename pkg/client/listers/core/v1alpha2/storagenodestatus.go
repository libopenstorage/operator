...
type StorageNodeStatusLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha2.StorageNodeStatus, err error)
...
// List lists all StorageNodeStatuses in the indexer.
func (s *storageNodeStatusLister) List(selector labels.Selector) (ret []*v1alpha2.StorageNodeStatus, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha2.StorageNodeStatus))
	})
	return ret, err
}
...
type StorageNodeStatusNamespaceLister interface {
	...
	Get(name string) (*v1alpha2.StorageNodeStatus, error)
...
// List lists all StorageNodeStatuses in the indexer for a given namespace.
func (s storageNodeStatusNamespaceLister) List(selector labels.Selector) (ret []*v1alpha2.StorageNodeStatus, err error) {
...
// Get retrieves the StorageNodeStatus from the indexer for a given namespace and name.
func (s storageNodeStatusNamespaceLister) Get(name string) (*v1alpha2.StorageNodeStatus, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha2.Resource("storagenodestatus"), name)
	}
	return obj.(*v1alpha2.StorageNodeStatus), nil
}
