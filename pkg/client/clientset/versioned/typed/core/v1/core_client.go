...
// CoreV1Client is used to interact with features provided by the core.libopenstorage.org group.
type CoreV1Client struct {
	restClient rest.Interface
}

func (c *CoreV1Client) StorageClusters(namespace string) StorageClusterInterface {
	return newStorageClusters(c, namespace)
}

func (c *CoreV1Client) StorageNodes(namespace string) StorageNodeInterface {
