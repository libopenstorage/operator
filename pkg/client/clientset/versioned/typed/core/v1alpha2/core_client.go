...
// CoreV1alpha2Client is used to interact with features provided by the core.libopenstorage.org group.
type CoreV1alpha2Client struct {
	restClient rest.Interface
}

func (c *CoreV1alpha2Client) StorageClusters(namespace string) StorageClusterInterface {
	return newStorageClusters(c, namespace)
}

func (c *CoreV1alpha2Client) StorageNodeStatuses(namespace string) StorageNodeStatusInterface {
