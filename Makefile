...
ifndef DOCKER_HUB_OPERATOR_TEST_TAG
    DOCKER_HUB_OPERATOR_TEST_TAG := test
...
OPERATOR_TEST_IMG=pure-artifactory.dev.purestorage.com/px-docker-dev-virtual/$(DOCKER_HUB_REPO)/$(DOCKER_HUB_OPERATOR_TEST_IMG):$(DOCKER_HUB_OPERATOR_TEST_TAG)
